...
contract ConsumablePartnerNFT is ERC721URIStorage, AccessControl {
    ...
    constructor(address _partnerAddress, string memory _partner) ERC721("PATNER", _partner) {
    ...
    function consume(uint256 tokenId) public returns(bool) {
        require(hasRole(CONSUMER_ROLE, msg.sender), "Unauthorized for consumption");
